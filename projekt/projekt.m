...
%Allokerar matriser för randvilkor
bc_lower = [];
bc_upper = [];
bc_left = [];
bc_right = [];

%Skapar matriser för randvilkor som kommer avnändas senare
for i = 1:n
    if p(2,i) == -1.5         
...
%Allokerar matris för formfunktioner som kommer användas för att beräkna
%f_b och Kc
...
p = p/1000;                                 %Gör om till postionen av koordinater till SI-enhet [m]
...
T_inf = 25;                                  %Temperatpur på ovansidan av balken
